...
function App() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-[#020617] via-[#0f172a] to-black flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      {(step > questions.length || showConfetti || step === 100) && (
        <button 
          onClick={handleReset}
          className="fixed top-4 left-4 md:top-8 md:left-8 z-50 bg-black/40 hover:bg-pink-600/50 border border-pink-500/30 rounded-full px-4 py-2 text-pink-200 text-sm md:text-base font-bold backdrop-blur-sm transition-all flex items-center gap-2 hover:scale-105 shadow-[0_0_15px_rgba(236,72,153,0.3)]"
        >
